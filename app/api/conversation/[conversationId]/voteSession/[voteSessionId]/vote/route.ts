...
export async function POST(request: Request, { params }: { params: Promise<{ voteSessionId: string }> }) {
    try {
        ...
        await pusherServer.trigger(voteSessionId, "voteSession_vote:new", newVoteSessionVote)
